...
(function() {
    ...
    C = (s.calculateScaleRange = function(t, i, e, s, o) {
        ...
        for (var d = Math.abs(u - c), p = y(d), f = Math.ceil(u / (1 * Math.pow(10, p))) * Math.pow(10, p), v = s ? 0 : Math.floor(c / (1 * Math.pow(10, p))) * Math.pow(10, p), S = f - v, x = Math.pow(10, p), C = Math.round(S / x); (C > h || h > 2 * C) && !l;) if (C > h) x *= 2,
        C = Math.round(S / x),
        C % 1 !== 0 && (l = !0);
        else if (o && p >= 0) {
            if (x / 2 % 1 !== 0) break;
    ...
    e.MultiTooltip = e.Element.extend({
        ...
        draw: function() {
            if (this.custom) this.custom(this);
                ...
                function(i, e) {
                    t.fillStyle = this.textColor,
                    t.fillText(i, this.x + this.xPadding + this.fontSize + 3, this.getLineHeight(e + 11)),
    ...
    e.animationService = {
        ...
        cancelAnimation: function(t) {
            var i = s.findNextWhere(this.animations,
            function(i) {
        ...
        startDigest: function() {
            ...
            for (var e = 0; e < this.animations.length; e++) null === this.animations[e].animationObject.currentStep && (this.animations[e].animationObject.currentStep = 0),
            ...
            this.animations[e].animationObject.currentStep == this.animations[e].animationObject.numSteps && (this.animations[e].animationObject.onAnimationComplete.call(this.animations[e].chartInstance), this.animations.splice(e, 1), e--);
            var n = Date.now(),
...
function() {
    ...
    i.Type.extend({
        ...
        draw: function(t) {
            ...
            this.scale && (this.scale.draw(i), e.each(this.datasets,
            function(t) {
