...
//提交办证接口
$(function(){
	var requestKey = "c466d7b3552f4b80b6b45974bd32c147";
	var requestSecret = "12406c4fc5221dc3e1f071ee43941285";
	...
	$.ajax({
		...
		data:{
			requestKey:'c466d7b3552f4b80b6b45974bd32c147',
			sign:sign,
			requestTime:time
		},
		dataType:'json',
...
//证照请求
	function getLiceseslist(icode){
		var requesturl;
		requesturl = "http://ag.sx.gov.cn/shaoxing/feixian/permissionCode.do";
		myRequest({
			url: requesturl,
			data: {
