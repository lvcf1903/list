new Vue({
    ...
    created:function(){
        ...
        if(ypzdwhdwwwbhdwdbkydwwxsfazynrbgspsqb != undefined){
            let bdarray = JSON.parse(localStorage.getItem("ypzdwhdwwwbhdwdbkydwwxsfazynrbgspsqb")).wordform[0];
    ...
    methods:{
        ...
        saveGo(){
            ...
            pramadic["txt_title"] = ['form_ypzdwhdwwwbhdwdbkydwwxsfazynrbgspsqb'];
            ...
            window.localStorage.ypzdwhdwwwbhdwdbkydwwxsfazynrbgspsqb = formXml;
            window.history.go(-1);
        }
    }
})