new Vue({
    ...
    created:function(){
        let sxjwwkhdwydzbhcsxksqb2 = window.localStorage.sxjwwkhdwydzbhcsxksqb2;
        if(sxjwwkhdwydzbhcsxksqb2 != undefined){
            let bdarray = JSON.parse(localStorage.getItem("sxjwwkhdwydzbhcsxksqb2")).wordform[0];
    ...
    methods:{
        ...
        saveGo(){
            ...
            pramadic["txt_title"] = ['form_sxjwwkhdwydzbhcsxksqb2'];
            ...
            window.localStorage.sxjwwkhdwydzbhcsxksqb2 = formXml;
            window.history.go(-1);
        }
    }
})