...
var sitename = decodeURI(theRequest.sitename);
...
function requestTime() {
	...
	myRequest({
		...
		success: function(data) {
			...
			requestTiemSuccess(JSON.parse(data));
	...
	/*myRequest({
		...
		/*	if(data.success == false) {*/
				myRequest({
					...
					header: '',
					url: "http://220.191.228.153:9090/lanxi/interfaces/yuyue/yyh.do",
