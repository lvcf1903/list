		...
		success: function(data) {
			if(data.length == 0) {
				...
				myRequest({
					...
					header: '',
					url: "http://127.0.0.1:8088/tonglu/tonglu/yuyue/queryImmdBystg.do",
					success: function(data) {
						if(data.length == 0) {
							myRequest({
								data: {
								...
								header: '',
								url: "http://127.0.0.1:8088/tonglu/tonglu/yuyue/insertimmd.do",
								success: function(data) {
							...
							myRequest({
								...
								header: '',
								url: "http://127.0.0.1:8088/tonglu/tonglu/yuyue/updateJsqh.do",
								success: function(data) {
									if(data.success == true) {
										var successy = "<strong style='color: #199efd;'>" + dataArrayrel[0].remark + "</strong>"
										$("#haveSuccess").html(successy);
