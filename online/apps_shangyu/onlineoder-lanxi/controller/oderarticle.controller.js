...
function requestOrderArticle() {
	...
	if(onlinetype == "01") { //网上预约 
		requesturl = overallInterface + "ywzw/interface/getOrderArticle.do";
	} else { //网上办证（证明）
...
function basicClicked() {
	document.getElementById("basicinfoTitle").style.color = "#FFFFFF";
	document.getElementById("basicinfoTitle").style.background = "#338dff";
	document.getElementById("processTitle").style.color = "#333333";
	document.getElementById("processTitle").style.background = "#EAEAEA";
...
function processClicked() {
	...
	document.getElementById("basicinfoTitle").style.background = "#EAEAEA";
	document.getElementById("processTitle").style.color = "#FFFFFF";
	document.getElementById("processTitle").style.background = "#338dff";
	document.getElementById("materialTitle").style.color = "#333333";
	document.getElementById("materialTitle").style.background = "#EAEAEA";
...
//}
//
//var lihtml = "<li id=\"{{item.index}}\" class=\"col-50 timeli\" style=\"vertical-align:middle;height:40px;margin-bottom: 20px;background: #ffffff;width: 44%;\" onclick=\"clickTime('{{item.indexa}}')\"><div class=\"timediv\" id=\"div{{item.indexb}}\"  align=\"center\" style=\"color:#333333;height: 40px;line-height: 40px;\">{{item.time}}</div></li>";
//var lihtmlNoValid = "<li id=\"{{item.index}}\" class=\"col-50\" style=\"vertical-align:middle;height:40px;margin-bottom: 20px;background: #ffffff;width: 44%;\"><div id=\"div{{item.indexb}}\"  align=\"center\" style=\"color:#CCCCCC;height: 40px;line-height: 40px;\">{{item.time}}</div></li>";
//
...
//	var storage = window.localStorage;
//	storage.orderPhone = "";
//	storage.orderItemname = "";
//	storage.orderDate = "";
//	storage.orderTimeslot = "";
//	storage.orderWindowName = "";
//	storage.orderNumber = "";
//
//	storage.orderPhone = userInfo.mobile;
//	storage.orderItemname = itemname;
//	storage.orderDate = orderDate;
//	storage.orderTimeslot = orderTime;
//
...
//			if(obj.result == "true") {
//				window.location.href = "odersuccess.html?type=01&ordernum=" + obj.ordernum + "&time=" + obj.time + "&address=" + obj.address + "&siteid=" + vsiteid;
//			} else {
